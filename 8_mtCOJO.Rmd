...
# Build mtcojo file with all the risk factors
...

# Send mCOJO
tmp_command="gcta64 --mbfile mtcojo_mbfile.txt --mtcojo-file list_of_trait.txt --ref-ld-chr eur_w_ld_chr/ --w-ld-chr eur_w_ld_chr/ --out mtcojo_BMI_result_vitaminD"
qsubshcom "$tmp_command" 1 30G mtCOJO 10:00:00 ""
```

I now have a new file called `mtcojo_result_vitaminD_result.mtcojo.cma` that is a GWAS summary statistics corrected for height.
...
```{r, eval=FALSE}
# Specific repo
cd /shares/compbio/Group-Wray/YanHoltz/VITAMIND_XIA_ET_AL/8_MTCOJO/GSMR
...
cat /shares/compbio/Group-Wray/YanHoltz/VITAMIND_XIA_ET_AL/8_MTCOJO/mtcojo_result_vitaminD_result.mtcojo.cma | cut -f1-8 > mtcojo_result_vitaminD_result.mtcojo.ma
echo "vitaminD /shares/compbio/Group-Wray/YanHoltz/VITAMIND_XIA_ET_AL/8_MTCOJO/GSMR/mtcojo_result_vitaminD_result.mtcojo.ma" > gsmr_exposure.txt
...
tmp_command="gcta64 --mbfile gsmr_ref_data.txt --gsmr-file gsmr_exposure.txt x{TASK_ID}  --gsmr-direction 0 --out gsmr_aftermtcojo_result_vitaminDXiaEtAl_{TASK_ID}"
qsubshcom "$tmp_command" 1 30G mtCOJO_GSMR_array 10:00:00 "-array=1-72"

# Once it's over, concatenate the results in a unique file
cat gsmr_aftermtcojo_result_vitaminDXiaEtAl*gsmr | head -1 > gsmr_aftermtcojo_result_vitaminDXiaEtAl.gsmr
cat gsmr_aftermtcojo_result_vitaminDXiaEtAl*gsmr | grep -v "Exposure" >>  gsmr_aftermtcojo_result_vitaminDXiaEtAl.gsmr
...
scp y.holtz@delta.imb.uq.edu.au:/shares/compbio/Group-Wray/YanHoltz/VITAMIND_XIA_ET_AL/8_MTCOJO/GSMR/gsmr_aftermtcojo_result_vitaminDXiaEtAl.gsmr .
```
