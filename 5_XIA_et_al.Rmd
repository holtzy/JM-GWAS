...
- `r gsmr %>% filter(p<0.05) %>% nrow()` significant associations (without multiple testing correction tough). 
- `r gsmr %>% filter(p<0.05 & bxy>0) %>% nrow()` of have a positive effect size: more Vitamin-D, more trait. 
- `r gsmr %>% filter(p<0.05 & bxy<0) %>% nrow()` have a negative effect size.
