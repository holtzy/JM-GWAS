...
# --- make a .linear format suitable for Plink
echo "CHR SNP BP A1 TEST NMISS BETA STAT P" > 25HydroxyVitaminD_QC.METAANALYSIS1.linear
zcat 25HydroxyVitaminD_QC.METAANALYSIS1.txt.gz | grep -v 'Chr' | awk '{ print $13, $1, $12, $2, "ADD", $14, $4, $4*$5, $6}' >> 25HydroxyVitaminD_QC.METAANALYSIS1.linear
R
data=read.table("25HydroxyVitaminD_QC.METAANALYSIS1.linear", header=T)
write.table(data, file="25HydroxyVitaminD_QC.METAANALYSIS1.linear", quote=F, row.names=FALSE )
```
...
tmp_command="plink \
          ...
          --clump /home/y.holtz/VITAMIND_XIA_ET_AL/25HydroxyVitaminD_QC.METAANALYSIS1.linear \
          --clump-p1 0.00001 --clump-p2 0.01 --clump-r2 0.50 --clump-kb 500 \
          --out /home/y.holtz/VITAMIND_XIA_ET_AL/25HydroxyVitaminD_QC.METAANALYSIS1.clump"
...
a FUMA analysis of this GWAS sumstat has been run
```{bash, eval=FALSE}
# transfer locally for FUMA?
cd /Users/y.holtz/Desktop
scp y.holtz@delta.imb.uq.edu.au:/home/y.holtz/VITAMIND_XIA_ET_AL/1_GWAS/25HydroxyVitaminD_QC.METAANALYSIS1.linear .
```
